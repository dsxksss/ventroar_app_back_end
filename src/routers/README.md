...
| **GetRoarComments**       | /getroarcomments       | 获取指定宣泄帖子的全部评论数据                      | GET    |
...
| api名称                     | 是否需要头部AuthToken或临时TokenT | 需要参数                                             | 返回result内容                                                                                                                                                                            |
| ------------------------- | ------------------------ | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **GetAllRoarText**        | NO                       | NULL                                             | [ { _id,text,isPublic,isShowUserName,isCanComment,smilLikeUsers[ ],heartLikeUsers[ ],textImages[ ],textCommentCount,createDate,smil,heart,userId,userName,userEmail,userAvatarUrl } ] |
| **GetRoarComments**       | NO                       | id(宣泄贴ID)                                        | [ { _id,commentText,isShowUserName,createDate,userId,userName,userEmail,userAvatarUrl } ]                                                                                             |
| **GetUserAllRoarText**    | YES header-token         | NULL                                             | [ { _id,text,isPublic,isShowUserName,isCanComment,smilLikeUsers[ ],heartLikeUsers[ ],textImages[ ],textCommentCount,createDate,smil,heart,userId,userName,userEmail,userAvatarUrl } ] |
| **PostRoarText**          | YES header-token         | text,isPublic,isShowUserName,isCanComment        | { _id,text,isPublic,isShowUserName,isCanComment,smilLikeUsers[ ],heartLikeUsers[ ],textImages[ ],textComments[ ],userId,createDate,smil,heart }                                       |
| **PostTextImages**        | YES header-token         | file:images <= 4                                 | { _id,text,isPublic,isShowUserName,isCanComment,smilLikeUsers[ ],heartLikeUsers[ ],textImages[ ],textComments[ ],userId,createDate,smil,heart }                                       |
| **ClickTextLikes**        | YES header-token         | textId,likeWho                                   | { smil,heart,smilLikeUsers[ ],heartLikeUsers[ ] }                                                                                                                                     |
| **PutRoarText**           | YES header-token         | textId,text,isPublic,isShowUserName,isCanComment | { _id,text,isPublic,isShowUserName,isCanComment,smilLikeUsers[ ],heartLikeUsers[ ],textImages[ ],textComments[ ],userId,createDate,smil,heart }                                       |
| **DeleteRoarText**        | YES header-token         | id(宣泄贴ID)                                        | { _id,text,isPublic,isShowUserName,isCanComment,smilLikeUsers[ ],heartLikeUsers[ ],textImages[ ],textComments[ ],userId,createDate,smil,heart } -> 被删除的宣泄贴                            |
